...
arr=[1,2,3,4]
brr="ebifboef";
// console.log(arr.slice(0,3)); // Before 3rd Index

// console.log(brr.slice(0,2)); // Before 2nd Index
//slice works for strings and arrays both
//splice works only for Arrays.
...
function balancedParenthesis(str){
    ...
    for(let i of str){
        ...
        if(obj[i]){
            ...
            console.log(stack);
            if(topElement!=char){
                console.log("Stack not arranged in Sequence"); 
                return false;
            }
        }
    }
